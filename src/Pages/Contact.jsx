        ...
        <div className="container">
          <div className="contact-div">
            <div className="contact-div__text">
              ...
              <a href="/">
                <i className="fa-solid fa-location-dot"></i>&nbsp; Dholpur,
                Rajasthan
              </a>
              <button className="mail" onClick={() => window.location = 'mailto:anubhavgoyal868@gmail.com'}>Mail Me</button>
            </div>
